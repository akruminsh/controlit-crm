...
export const SendEmailVerificationLinkEmail = ({
  ...
  const bodyId = isEmailUpdate
    ? 'We received a request to change the email address associated with your Controlit Factory CRM account. Click below to confirm this change.'
    : 'Thanks for registering for a Controlit Factory CRM account. Before we get started, we just need to confirm that this is you. Click below to verify your email address.';
...
SendEmailVerificationLinkEmail.PreviewProps = {
  link: 'https://crm.controlitfactory.eu/verify-email/123',
  locale: 'en',
  isEmailUpdate: false,
};
