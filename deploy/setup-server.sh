...
echo ""
echo "Next steps:"
echo "1. Copy docker-compose.prod.yml to /opt/controlit-crm/docker-compose.yml"
echo "2. Copy update-crm.sh and .env file to /opt/controlit-crm/"
echo "3. Ensure PG_DATABASE_PASSWORD uses only URL-safe characters: letters, numbers, dot, underscore, hyphen, tilde"
echo "4. Run: cd /opt/controlit-crm && TAG=<image-tag> ./update-crm.sh"
